...
@Entity
@Table(indexes = {
        @Index(name = "IDX_PRODUCT_IDS", columnList = "productId,productUuid") })
public class Product extends ShopObject {
    // @formatter:off

    @Id
    @GenericGenerator(name = "productSequenceGenerator", strategy = "org.hibernate.id.enhanced.SequenceStyleGenerator", parameters = {
    ...
    public String toString() {
        return "Product [productId=" + productId + ", productUuid="
                + productUuid + ", name=" + name + ", shortDescription="
    ...
    public int hashCode() {
        ...
        int result = 1;
        result = prime * result
                + ((productUuid == null) ? 0 : productUuid.hashCode());
        return result;
    }
